...
function delResponse(result)
{
		...
		<?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_21133200_1387288149');$this->_foreach['cart_goods_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['cart_goods_list']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_21133200_1387288149']):
        $this->_foreach['cart_goods_list']['iteration']++;
?>
		<ul>
			<li style="width:60px"><?php echo $this->_var['goods_0_21133200_1387288149']['goods_name']; ?></li>
			<li style="width:15px"><?php echo $this->_var['goods_0_21133200_1387288149']['goods_number']; ?></li>
			<li style="width:55px"><?php echo $this->_var['goods_0_21133200_1387288149']['goods_price']; ?></li>
			<li><a href="javascript:delgoods2(<?php echo $this->_var['goods_0_21133200_1387288149']['rec_id']; ?>);"><img src="themes/default/images/cancel.gif" width="12" height="12" /></a></li> 
		</ul>
