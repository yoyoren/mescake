...
elseif ($_REQUEST['step'] == 'done') {
	...
	$sql = "INSERT INTO " . $ecs -> table('order_goods') . "( " . "order_id, goods_id, goods_name, goods_sn, goods_number,  " . "goods_price, goods_attr, goods_discount,is_integral, origin_rec_id,parent_id, goods_attr_id) " . " SELECT '$new_order_id', goods_id, goods_name, goods_sn, goods_number,  " . "goods_price, goods_attr, if(is_integral,-1,1) ,is_integral,rec_id,parent_id, goods_attr_id" . " FROM " . $ecs -> table('cart') . " WHERE session_id = '" . SESS_ID . "' AND rec_type = '$flow_type'";	
