...
if (!$smarty->is_cached('goods.dwt', $cache_id))
{
    ...
    else
    {
		...
		if(in_array($goods_id,$wine_list)) $smarty->assign('wine',1);
		if(in_array($goods_id,$nut_list)) $smarty->assign('nut',1); 
		if(in_array($goods_id,$qkl_list)) $smarty->assign('qkl',1); 
...
function getattr($attr_id){
	$sql = "SELECT  ga.attr_value ".
	...
	if ($attr == '1.0') $num['cj'] = 5;
	if ($attr == '2.0') $num['cj'] = 10;
	if ($attr == '3.0') $num['cj'] = 15;
	if ($attr == '5.0') $num['cj'] = 20;
	if ($attr == '10.') $num['cj'] = 40;
	if ($attr == '15.') $num['cj'] = 50;
	if ($attr == '20.') $num['cj']= 80;
	if ($attr == '25.') $num['cj'] = 100;			           
	if ($attr == '30.') $num['cj'] = 120;
	if ($attr == '1.0') $num['cd'] = 1;
	if ($attr == '2.0') $num['cd'] = 1;
	if ($attr == '3.0') $num['cd'] = 1;
	if ($attr == '5.0') $num['cd'] = 2;
	if ($attr == '10.') $num['cd'] = 2;
	if ($attr == '15.') $num['cd'] = 3;
	if ($attr == '20.') $num['cd']= 4;
	if ($attr == '25.') $num['cd'] = 5;			           
