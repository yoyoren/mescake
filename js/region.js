...
region.changed = function(obj, type, selName)
{
  ...
  if(document.getElementById('selCountries').value=='444'){
  document.getElementById('szhwfdiv').style.display="block";
  }else{document.getElementById('szhwfdiv').style.display="none";}
