      <ul class="order-ul">
        ...
        <li class="li-bg order-add-more">
          <label for="birth_chk" id="birth_title"><input type="checkbox" id="birth_chk" class="checkbox-item">我要添加特别的生日蜡烛（+5元/份）</label><br>
          <label style="display:none" for="leaveMes" id="leave_message"><input type="checkbox" class="checkbox-item">留言说明</label><br>
