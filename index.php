...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    //首页分类
    $sql="select cat_id,cat_name from ecs_category  where parent_id=1";
	$res =$GLOBALS['db']->getAll($sql);
	foreach($res as $k=>$v)
	{
		if($v['cat_id']==3) $res[$k]['cat_img']="images/51.png";
		if($v['cat_id']==4) $res[$k]['cat_img']="images/43.png";
		if($v['cat_id']==5) $res[$k]['cat_img']="images/35.png";
		if($v['cat_id']==6) $res[$k]['cat_img']="images/55.png";
		if($v['cat_id']==7) $res[$k]['cat_img']="images/93.png";
		if($v['cat_id']==8) $res[$k]['cat_img']="images/53.png";
		if($v['cat_id']==9) $res[$k]['cat_img']="images/40.png";
		if($v['cat_id']==10) $res[$k]['cat_img']="images/75.png";
		
	}
	 $smarty->assign('cat_info', $res);
    /* 页面中的动态内容 */
